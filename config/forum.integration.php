    ...
    */
    ...
    'policies' => [
        ...
        'model' => [
            ...
            App\Models\Forum\Category::class  => Riari\Forum\Policies\CategoryPolicy::class,
            App\Models\Forum\Thread::class    => Riari\Forum\Policies\ThreadPolicy::class,
            App\Models\Forum\Post::class      => Riari\Forum\Policies\PostPolicy::class
        ]
    ],
